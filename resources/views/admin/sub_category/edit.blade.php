...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="card">
                <form action="" method="post" class="subcategoryFormupdate">
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="parent_category" id="parent_category" id="parent_category"
                                        ...
                                        @foreach ($p_category as $cat)
                                            <option value="{{ $cat->id }}"
                                                @foreach ($category->parentCategories as $pcat) @if ($cat->id == $pcat->id) {{ 'selected' }} @endif @endforeach>
                                                {{ $cat->name }}</option>
                                        @endforeach
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.subcategoryFormupdate').submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('subcategories.update', $category->id) }}',
                    type: 'post',
                    dataType: 'json',

                    ...
                    <div class="card-header">
                        <div class="card-title">
                            <button class="btn btn-info" type="button"
                                onclick="window.location.href='{{ route('products') }}'"">Reset</button>
                        </div>
                        ...
                        <tbody>
                            ...
                            @if ($products->isNotEmpty())
                                ...
                                @foreach ($products as $key => $product)
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td><img src="<?php foreach ($product->g_images as $imgs) {
                                        ...
                                        <td>
                                            <form action="" method="">
                                                @if ($product->status == 1)
                                                    <a class="change-status" data-status="{{ $product->status }}"
                                                ...
                                                @else
                                                    <a class="change-status" data-status="{{ $product->status }}"
                                                        data-id="{{ $product->id }}"> <svg class="text-danger h-6 w-6"
                                                            xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                                            aria-hidden="true">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <td>
                                            ...
                                            <a href="#" data-id="{{ $product->id }}"
                                                class="text-danger w-4 h-4 mr-1 delete-product">
    ...
    <script>
        ...
        $('.delete-product').on('click', function(e) {
            ...
            if (confirm('Are you sure want to delete ?')) {
                ...
                var id = $(this).attr('data-id');
                var nurl = '{{ route('products.delete', 'ID') }}';

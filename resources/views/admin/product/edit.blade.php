                ...
                <div class="row">
                    <div class="col-md-8">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="slug" id="slug"
                                                value="{{ $products->slug }}" class="form-control" placeholder="Title">
                                            <p class="errors"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                        ...
                        <div class="row mb-3 image-thumb" id="image-thumb" style="">
                            <div class="col-md-3">
                                <div class="card" width="16%;"> <img src="<?php foreach ($products->g_images as $imgs) {
                                    echo url('/') . '/temp/' . $imgs->image;
                                } ?>" class="card-img-top">
                                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="sku" value="{{ $products->sku }}" id="sku"
                                        ...
                                        <div class="mb-3">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <input class="custom-control-input" type="checkbox"
                                                    value="{{ $products->track_qty }}" id="track_qty" name="track_qty"
                                                    @if ($products->track_qty == 'Yes') {{ 'checked' }} @endif>
                                                <label for="track_qty" class="custom-control-label">Track Quantity</label>
                                                <p class="errors"></p>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <input type="number" min="0" value="{{ $products->qty }}"
                            ...
                            <div class="card-body">
                                        ...
                                        @if (!empty($categories))
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    @if ($products->category_id == $category->id) {{ 'selected' }} @endif>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="sub_category" id="sub_category" class="form-control">
                                        ...
                                        @if (!empty($products->sub_category_id))
                                            @foreach ($products->subCategories as $category)
                                                <option value="{{ $category->id }}"
                                                    @if ($products->sub_category_id == $category->id) {{ 'selected' }} @endif>
                                                    {{ $category->name }}</option>
                                            @endforeach
                                        @endif
                                        ...
                                        @if (!empty($brands))
                                            @foreach ($brands as $brand)
                                                <option value="{{ $brand->id }}"
                                                    @if ($products->brand_id == $brand->id) {{ 'selected' }} @endif>
                                                    {{ $brand->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select name="is_featured" id="is_featured" class="form-control">
                                        <option value="No"
                                            @if ($products->is_featured == 'No') {{ 'selected' }} @endif>

                                            No
                                        </option>
                                        <option value="Yes"
                                            @if ($products->is_featured == 'Yes') {{ 'selected' }} @endif>
